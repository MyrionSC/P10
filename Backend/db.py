...
dijkstra_qry = '\'SELECT segmentkey as id, startpoint as source, endpoint as target, segmentgeom as the_geom, cost FROM maps.routing3 rou JOIN models.no_time model ON model.segmentkey = rou.segmentkey AND model.direction = rou.direction\''
