...
UPDATE experiments.rmp10_driven_supersegments_2len as ds2l
...
FROM (
	WITH supersegs AS (
		...
		FROM experiments.rmp10_driven_supersegments_2len segs
...
WHERE 
	ds2l.point=sq.point AND
	ds2l.segments[1]=sq.in_segkey AND
	ds2l.segments[2]=sq.out_segkey
