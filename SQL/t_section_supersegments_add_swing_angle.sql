ALTER TABLE experiments.rmp10_t_section_supersegments
ADD COLUMN angle double precision,
ADD COLUMN direction text;

UPDATE experiments.rmp10_t_section_supersegments ss
...
FROM (
	WITH supersegs AS (
		...
		FROM experiments.rmp10_t_section_supersegments segs
